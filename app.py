...
import datetime
import random
import base6code if False else None

app = Flask(__name__)
app.secret_key = 'kesh_aadar_secure_key_2026_super_secret'
...
# --- IN-MEMORY DATABASE & STORAGE (Stateful for server run) ---
# Status steps: Order Placed -> Packaging -> Shipped -> Delivered
PRODUCTS = [
    {
        "id": 1, 
